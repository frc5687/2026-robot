...
class LimelightVisionIO : public VisionIO {
 public:
  ...
  void SetRobotOrientation(units::degree_t yaw, units::degrees_per_second_t yawRate = 0.0_deg_per_s,
                           units::degree_t pitch = 0.0_deg, units::degrees_per_second_t pitchRate = 0.0_deg_per_s,
                           units::degree_t roll = 0.0_deg, units::degrees_per_second_t rollRate = 0.0_deg_per_s);
 ...
 private:
  ...
  VisionMeasurement MeasurementFromEstimate(
