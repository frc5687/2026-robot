...
inline constexpr frc::Transform3d kRobotToLeftCam{
    frc::Translation3d{-0.165_m, 0.343_m, 0.527_m},
    frc::Rotation3d{0_deg, 5_deg, -90_deg}};

inline constexpr frc::Transform3d kRobotToRightCam{
    frc::Translation3d{-0.165_m, -0.343_m, 0.527_m},
    frc::Rotation3d{0_deg, 5_deg, 90_deg}};

inline const std::unordered_map<std::string, frc::Transform3d> kTransformMap = {
    {"limelight", kRobotToCam},
    {"limelight-left", kRobotToLeftCam},
    {"limelight-right", kRobotToRightCam},
