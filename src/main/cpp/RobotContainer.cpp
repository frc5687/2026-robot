    ...
    RobotContainer::RobotContainer():
        ...
        m_shooterHoodAngle("shooterangle","angle", 0.5)
    {
    ...
    //       .ToPtr());
        ...
        m_driver.Square().OnTrue(Run(
            [this] { m_flywheel->SetRPM(units::angular_velocity::revolutions_per_minute_t{0});  }, {m_flywheel.get()}));
    ...
    m_driver.Triangle().OnTrue(Run(
        ...
        [this] { m_hood->SetHoodPosition(units::angle::turn_t{m_shooterHoodAngle.Get()}); }, {m_hood.get()})); 
