...
SimIntakeTopRollerIO::SimIntakeTopRollerIO()
    : m_motorSim(
          frc::LinearSystemId::DCMotorSystem(kMotor, kInertia, kGearRatio),
          kMotor),
      m_pid(PID::kP, 0.0, PID::kD) {}

units::volt_t SimIntakeTopRollerIO::CalculateClosedLoop() {
...
void SimIntakeTopRollerIO::UpdateInputs(IntakeTopRollerIOInputs &inputs) {
...
void SimIntakeTopRollerIO::Stop() {
