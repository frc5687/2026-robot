...
SimIntakeBottomRollerIO::SimIntakeBottomRollerIO()
    : m_motorSim(
          frc::LinearSystemId::DCMotorSystem(kMotor, kInertia, kGearRatio),
          kMotor),
      m_pid(PID::kP, 0.0, PID::kD) {}

units::volt_t SimIntakeBottomRollerIO::CalculateClosedLoop() {
...
void SimIntakeBottomRollerIO::UpdateInputs(IntakeBottomRollerIOInputs &inputs) {
...
void SimIntakeBottomRollerIO::Stop() {
