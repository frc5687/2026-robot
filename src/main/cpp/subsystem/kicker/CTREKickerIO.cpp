...
CTREKickerIO::CTREKickerIO(const CANDevice &leader, const CANDevice &follower)
...
void CTREKickerIO::ConfigureDevices() {
...
void CTREKickerIO::ConfigureClosedLoop() {
...
void CTREKickerIO::ConfigureSignalFrequencies() {
...
void CTREKickerIO::UpdateInputs(KickerIOInputs &inputs) {
